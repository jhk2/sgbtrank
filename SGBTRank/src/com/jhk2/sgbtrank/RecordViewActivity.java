...
public class RecordViewActivity extends ActionBarActivity {
	...
	public void onDailyResultsClick(View view) {
		Intent intent = new Intent(this, DailyResultsActivity.class);
    	startActivity(intent);
	}
	
	public void onOverallRanksClick(View view) {
		Intent intent = new Intent(this, OverallRanksActivity.class);
		startActivity(intent);
	}
	
	public void onRefreshDataClick(View view) {
		((SGBTRankApplication) getApplication()).refreshData();
	}
